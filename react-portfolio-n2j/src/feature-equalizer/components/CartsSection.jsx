const CartSection = () => {
  return (
    <div className=" flex-col mt-[15rem] mr-[-5%] ml-[-5%] xl:flex-row lg:mr-16 lg:flex-row lg:ml-0 lg:mt-[18rem] md:flex-row md:mr-6 md:ml-1 md:mt-[15rem] sm:flex-row sm:ml-[-3rem] flex md:flex  ">
      <div className=" h-[600px] bg-black xl:h-[600px] xl:w-[1110px] lg:w-[850px] lg:h-[500px] flex rounded-xl md:w-[696px] md:h-[600px] sm:w-[600px] sm:h-[520px] ">
        <div className=" w-[600px] h-[500px] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] z-40 md:z-40 sm:z-40 ">
          <img
            className="ml-[70%]  mr-[30%] mt-[-5rem] w-[650px] h-[350px] bg-cover xl:h-[642px] xl:w-[312px] xl:ml-[4rem] xl:mt-[-180px] md:w-[270px] md:h-[556px] md:mt-[-120px] md:ml-[3rem] sm:h-[500px] sm:w-[220px] sm:mt-[-6rem] sm:ml-6"
            src="/src/feature-equalizer/assets/illustration-app.png"
            alt=""
            srcSet=""
          />
        </div>
        <div className=" w-[900px] h-[420px] lg:w-[350px] md:w-[280px] sm:w-[220px]">
          <img
            className="ml-[-40%] w-[500px] h-[420px] lg:bg-cover xl:ml-[-35rem] lg:ml-[-25rem] md:ml-[-16rem] sm:ml-[-15rem]  "
      ...
      <div className=" mt-[-15rem] rounded-xl bg-[#FA7453] p-10 text-white xl:w-[446px] xl:h-[600px] xl:mt-[7rem] xl:ml-[-40rem] pb-[5rem] xl:p-10 lg:ml-[-28rem] lg:w-[400px] lg:h-[580px] lg:mt-[7rem] lg:rounded-xl md:w-[399px] md:h-[580px] md:ml-[-29rem] md:z-40 md:mt-[10rem] md:p-10 md:rounded-xl sm:w-[330px] sm:h-[520px] sm:rounded-xl sm:p-8 sm:mt-[7rem] sm:ml-[-25rem] sm:z-40 ">
        <div className=" text-4xl  font-bold xl:text-4xl xl:font-bold font-titleEqualizer xl:mb-[1.5rem] md:text-3xl md:font-bold md:mb-[1rem]">
          Premium EQ
        </div>
