  ...
  return (
    <div className="pt-6 pl-4 h-[95px] mb-[6rem]">
      <div className="grid lg:grid-cols-3 grid-cols-2">
        ...
        <div className=" ml-[-3rem] sm:ml-[-5rem] pt-5 col-start-2">
          <div
          ...
          <div className="lg:col-start-2 ml-[-5rem] md:col-start-1 pt-5 md:pt-8 md:ml-[-10rem] sm:ml-[-10rem] sm:pt-8 lg:ml-0 text-sm sm:text-base">
            <div className="line-clamp-2 w-[490px] md:w-[493px] text-sm sm:text-base">
